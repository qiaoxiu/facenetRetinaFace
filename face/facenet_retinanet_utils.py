...
from infer2 import get_embeddings
import numpy as np
import os
import time
import torch
...
def _get_all_encoding():
    ...
    if os.path.exists('new_data3.npz'):
        ...
        os.remove('new_data3.npz')
    print(known_face_names)
    np.savez('all3.npz', encode=known_face_encodings, sids=sids, names=known_face_names)
